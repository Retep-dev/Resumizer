  ...
  return (
    <div className="card-panel p-4 sm:p-6 rounded-3xl space-y-6 w-full">
      <div className="flex items-center space-x-3 pb-4 border-b border-slate-200">
        ...
        <div>
          <h3 className="text-base sm:text-lg font-extrabold text-[#069494]">Tailored Resume & STAR Rewriter</h3>
      ...
      {rewriteReport.tailored_summary && (
        <div className="p-4 rounded-2xl bg-[#00F0FF]/10 border border-[#00F0FF]/40 space-y-2">
      ...
      <div className="space-y-6">
        {rewriteReport.rewritten_experiences?.map((exp, expIdx) => (
          <div key={expIdx} className="space-y-3">
            <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-extrabold text-[#069494]">
            ...
            <div className="space-y-3">
              {exp.rewritten_bullets?.map((bullet, bulletIdx) => {
                ...
                return (
                  <div key={bulletIdx} className="p-4 rounded-2xl bg-slate-50 border border-slate-200 grid grid-cols-1 lg:grid-cols-2 gap-4 relative group">
                    {/* Original */}
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="p-1 text-slate-600 hover:text-[#069494] rounded-md bg-white border border-slate-300 transition"
                      ...
                      <p className="text-xs text-slate-900 font-bold leading-relaxed bg-[#00F0FF]/15 p-3 rounded-xl border border-[#00F0FF]/40">
                        ...
                        <div className="flex items-center space-x-1 text-[10px] text-slate-500 font-semibold mt-1">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {bullet.added_keywords.map((kw, i) => (
                              <span key={i} className="px-1.5 py-0.5 rounded bg-[#069494] text-white font-mono font-bold">
                                {kw}
                              </span>
                            ))}
                          </div>
